...
export default function Hero() {
  return (
    <section id="hero" className="flex flex-col lg:flex-row pt-20 m-10 ">
      <motion.div
      ...
      >
        <p className="text-gray-400 ">Olá, eu sou</p>
        ...
        <div className=" flex flex-row gap-5 mt-2">
          ...
          <button className=" cursor-pointer w-fit flex flex-row border border-[#8B5CF6] rounded-lg gap-2 items-center px-6 py-3">
      ...
      <motion.div
        className=" flex-1 flex justify-center ml-15"
        initial={{ opacity: 0, x: 80 }}
        animate={{ opacity: 1, x: 0 }}
        transition={{
          duration: 1.5,
      ...
      >
        <Image
          ...
          width={380}
          height={380}
          className="w-full max-w-95 h-auto rounded-full shadow-[0_0_40px_#8B5CF6]"
          priority
        />
      </motion.div>
    </section>
